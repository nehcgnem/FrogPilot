...
def translate_file(path: pathlib.Path, language: str, all_: bool, vet_translations: bool) -> None:
  ...
  for context in root.findall("./context"):
    ...
    for message in context.findall("./message"):
      ...
      if vet_translations and (translation.attrib.get("type") != "unfinished" and not translation.attrib.get("type", "").endswith("-generated")):
        continue
      elif not all_ and translation.attrib.get("type") != "unfinished":
        continue
