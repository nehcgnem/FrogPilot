...
void Sidebar::showEvent(QShowEvent *event) {
  ...
  sidebar_color1 = frogpilot_toggles.value("color_scheme").toString() == "stock" ? good_color : loadThemeColors("Sidebar1");
  sidebar_color2 = frogpilot_toggles.value("color_scheme").toString() == "stock" ? good_color : loadThemeColors("Sidebar2");
  sidebar_color3 = frogpilot_toggles.value("color_scheme").toString() == "stock" ? good_color : loadThemeColors("Sidebar3");
